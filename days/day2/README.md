...
- **Part 1** (from repo root):
  ```bash
  cargo run -p day2 --release part1 < days/day2/input.txt
  ```

- **Part 2** (from repo root):
  ```bash
  cargo run -p day2 --release part2 < days/day2/input2.txt
  ```

- **From inside the day2 directory:**
  ```bash
  cd days/day2
  cargo run --release part1 < input.txt
  cargo run --release part2 < input2.txt
  ```